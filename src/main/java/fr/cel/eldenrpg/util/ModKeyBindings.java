...
public class ModKeyBindings {
    ...
    public static final String KEY_BACKPACK = "key.eldenrpg.backpack";
    ...
    public static final KeyMapping BACKPACK = new KeyMapping(
            KEY_BACKPACK, KeyConflictContext.IN_GAME, InputConstants.Type.KEYSYM, GLFW.GLFW_KEY_I, KEY_CATEGORY_ELDENRPG);
